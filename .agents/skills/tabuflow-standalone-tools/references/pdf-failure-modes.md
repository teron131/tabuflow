...
Images are evidence, not the default extraction input. Use 2x2 overview batches first, then focused full-page images only for ambiguous pages, scanned pages, boundaries, or hierarchy.
