...
description: Use when creating or improving a domain skill from real source artifacts, reference outputs, pressure-test failures, repeated agent mistakes, or unclear input/output contracts.
---
...
- source artifacts the future agent will receive,
...
A skill revision is good when a fresh agent can:
